...
func TestValidateDl3000(t *testing.T) {
	...
	if RuleSet.ValidateDl3000(absWorkdirCommand) != true {
	...
	if RuleSet.ValidateDl3000(nonAbsWorkdirCommand1) != false {
	...
	if RuleSet.ValidateDl3000(nonAbsWorkdirCommand2) != false {
